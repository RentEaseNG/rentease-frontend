...
description: "Manage bookings, payments, and communication in one place.",
  ...
  return (
    <>
        ...
        <section className='bg-green-800 p-10 mt-0 md:-mt-20'>
          ...
          <button className='bg-white mb-5 text-green-800 font-bold py-2 px-4 rounded mt-5 block mx-auto hover:bg-gray-200'>List Your Property</button>
        </section>
